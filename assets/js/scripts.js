...
checkoutBtn.addEventListener("click", function () {
    ...
    if (!phoneNumber || !address) {
        ...
        return; // Para o fluxo se não houver telefone ou endereço
    }
...
function checkOpeningHours() {
    ...
    // Aberto entre 18:00 e 01:00 (considerando que 01:00 pertence ao próximo dia)
    return (hora >= 18 || hora < 1);
}

// Atualizar status de funcionamento
const spanItem = document.querySelector("#status"); // Selecione o elemento onde deseja exibir o status
const isOpen = checkOpeningHours();
